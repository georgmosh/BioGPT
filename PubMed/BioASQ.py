...
class DataLoader:
    def __init__(self, mode="Load", split="training11b.json"):
        ...
        self.BioASQ_DIR = r"C:\Users\Georgios Moschovis\Documents\BIOASQ 11b"
        self.PubMed_DIR = r"C:\Users\Georgios Moschovis\Documents\BIOASQ 11b\PubMed"
    ...
    def load_json(self, filename):
        file = open(os.path.join(self.BioASQ_DIR, filename), encoding="utf8")
        data = json.load(file)
        file.close()
